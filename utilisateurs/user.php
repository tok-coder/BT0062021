...
<!--	</div>
		...
		if(isset($_SESSION['id']) AND $userinf["id"]==$_SESSION['id'])
		{
			...
			?>
			e-mail: <?php echo "<strong>".$userinf['email']."</strong>";
		    echo "<br>";?>
			Niveau: <?php echo "<strong>".$userinf['niveau_etude']."</strong>";
		    echo "<br>";?>
			Date de naissance: <?php echo "<strong>".$userinf['date_naissance']."</strong>";
		    echo "<br>";?>
			Adresse: <?php echo "<strong>".$userinf['adresse']."</strong>";
		    echo "<br>";?>
			Telephone: <?php echo "<strong>".$userinf['telephone']."</strong>";
		    echo "<br>";?>
			Genre: <?php echo "<strong>".$userinf['genre']."</strong>";
		    echo "<br>";?>
			<a href="editerprofil_etudiant.php" class="w3-bar-item w3-button w3-blue  w3-large"><i class="fa fa-user">Editer mon profil</i></a></div><br></div><br>
