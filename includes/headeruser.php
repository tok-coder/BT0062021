...
<body>
   ...
   <a href="../contact.php" class="w3-button w3-large w3-bar-item w3-right"><i class="fa fa-envelope"> Apprendre</i></a>
   <a href="../contact.php" class="w3-button w3-large w3-bar-item w3-right"><i class="fa fa-envelope"> Formations</i></a>
