...
include("includes/headerins.php");
    ...
    move_uploaded_file($_FILES['img']['tmp_name'],$upload);
				$sql = "INSERT INTO utilisateur(prenom,nom,telephone,email,motdepasse,date,adresse,genre,niveau_etude,date_naissance,avatar) VALUES ('$prenom','$nom','$tel','$mail','$pass',now(),'$adresse','$genre','$niveau','$naissance','$photo')";
